  ...
  return (
    <div className="bg-[#F5F5F5] text-[#111111] font-sans font-light selection:bg-[#C5A059] selection:text-white transition-colors duration-500">
        ...
        <div className="relative z-10 container mx-auto px-6 h-full flex flex-col md:flex-row justify-center md:justify-between items-center pt-20">
          <div className="order-2 md:order-1 mt-12 md:mt-0 w-full md:w-1/2 flex justify-center md:justify-start lg:pl-12">
            <div className="border-l border-[#C5A059] pl-6 py-2 text-left">
              <p className="font-semibold text-[#C5A059] tracking-[0.2em] text-sm mb-2">LIMITED OPEN</p>
              <p className="text-[#111111] text-lg tracking-wider font-semibold">2026.09.26 <span className="text-sm mx-1">SAT</span> - 09.27 <span className="text-sm mx-1">SUN</span></p>
          ...
          <div className="order-1 md:order-2 w-full md:w-1/2 flex justify-center md:justify-end md:pr-12 lg:pr-24">
            <div className="flex h-64 gap-8 lg:gap-12">
              <h2 className="text-3xl lg:text-5xl text-[#111111] leading-loose" style={{ writingMode: 'vertical-rl', letterSpacing: '0.2em' }}>
                至高の粉もん、
              </h2>
              <h2 className="text-3xl lg:text-5xl text-[#111111] leading-loose mt-12" style={{ writingMode: 'vertical-rl', letterSpacing: '0.2em' }}>
                ここに開店。
              </h2>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/3">
              <h3 className="text-[#C5A059] text-4xl lg:text-5xl tracking-widest opacity-30 font-semibold">CONCEPT</h3>
              <h2 className="text-2xl lg:text-3xl mt-[-1.5rem] ml-4 lg:ml-8 text-[#111111] font-bold">洗練と、<br/>情熱のひとくち。</h2>
            </div>
      ...
      <section id="news" className="py-24 bg-white relative">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl tracking-[0.3em] text-[#111111] font-bold">NEWS</h2>
            ...
            {newsList && newsList.length > 0 ? (
              newsList.map((news) => {
                ...
                <div key={news.id} className="border-b border-gray-200 pb-6 flex flex-col md:flex-row gap-4 md:gap-8">
                  <div className="text-[#C5A059] font-bold shrink-0 w-32">
                    {dateStr}
                  </div>
                  <div>
      ...
      <section id="menu" className="py-24 bg-white relative">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16 lg:mb-24">
            <h2 className="text-3xl tracking-[0.3em] text-[#111111] font-bold">MENU</h2>
            <div className="w-12 h-px bg-[#C5A059] mx-auto mt-4"></div>
          </div>
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24">
            <div className="group cursor-pointer">
              ...
              <div className="flex justify-between items-baseline mb-3">
                <h3 className="text-2xl text-[#111111] font-bold">ソースたこ焼き</h3>
                <span className="text-xl text-[#C5A059] tracking-widest font-bold">¥500</span>
              </div>
            ...
            <div className="group cursor-pointer lg:mt-24">
              ...
              <div className="flex justify-between items-baseline mb-3">
                <h3 className="text-2xl text-[#111111] font-bold">明石焼き</h3>
                <span className="text-xl text-[#C5A059] tracking-widest font-bold">¥600</span>
              </div>
              <p className="text-sm text-gray-600 leading-relaxed">
      ...
      <section id="access" className="py-24 relative">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl tracking-[0.3em] text-[#111111] font-bold">INFORMATION</h2>
            <div className="w-12 h-px bg-[#C5A059] mx-auto mt-4"></div>
          </div>
          <div className="border border-gray-300 p-8 lg:p-12 relative bg-white/60 backdrop-blur-sm">
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-lg text-[#111111] mb-2 font-bold">令和8年度 〇〇高校 文化祭</p>
